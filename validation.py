...
parser.add_argument('-tdp', '--test_data_path', type=str, default='/home/ubuntu/workspace/bekhzod/allconec/3D-UNet/Datasets/Task09_Spleen')
...
parser.add_argument('-cp', '--checkpoint_path', type=str, default='./work_dir/spleen/sam_model_dice_best.pth')
